...
const ALL = [
  ...
  {
    id: 'com.bluehost.Fix San',
    name: 'Zaam-Dox',
    description:
      'Quisque ut erat. Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.',
  },
  {
    id: 'com.scribd.Zaam-Dox',
    name: 'Sub-Ex',
    description:
  ...
  {
    id: 'com.yahoo.Redhold',
    name: 'Solarbreeze',
    description:
      'Curabitur convallis. Duis consequat dui nec nisi volutpat eleifend. Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus. Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis.',
  },
  {
    id: 'com.bravesites.Ronstring',
    name: 'Tin',
    description:
      'Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.',
  },
  {
    id: 'edu.stanford.Aerified',
    name: 'Andalax',
    description:
  ...
  {
    id: 'com.over-blog.Tresom',
    name: 'Namfix',
    description:
      'Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa.',
  },
  {
    id: 'com.netscape.Lotlux',
    name: 'Wrapsafe',
    description: 'Duis bibendum. Morbi non quam nec dui luctus rutrum.',
  },
  {
    id: 'net.behance.Zathin',
    name: 'Mat Lam Tam',
  ...
  {
    id: 'gov.senate.Matsoft',
    name: 'Latlux',
    description:
      'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.',
  },
  {
    id: 'ru.rambler.Daltfresh',
    name: 'Y-Solowarm',
  ...
  {
    id: 'com.indiegogo.Viva',
    name: 'Solarbreeze',
    description:
      'Donec posuere metus vitae ipsum. Aliquam non mauris. Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet.',
  },
  {
    id: 'com.mashable.Tres-Zap',
    name: 'Gembucket',
    description:
      'Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante.',
  },
  {
    id: 'net.a8.Ventosanzap',
    name: 'It',
    description:
  ...
  {
    id: 'cz.toplist.Zathin',
    name: 'Holdlamis',
    description: 'Nam dui.',
  },
  {
    id: 'com.oakley.Sonsing',
    name: 'Ventosanzap',
    description: 'Nullam molestie nibh in lectus.',
  },
  {
    id: 'com.smugmug.Konklux',
    name: 'Andalax',
    description:
